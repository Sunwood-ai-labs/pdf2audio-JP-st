...
>[!IMPORTANT]
>Nearly 90% of the release notes, README, and commit messages in this repository were generated by [claude.ai](https://claude.ai/) and [ChatGPT4](https://chatgpt.com/) using [AIRA](https://github.com/Sunwood-ai-labs/AIRA), [SourceSage](https://github.com/Sunwood-ai-labs/SourceSage), [Gaiah](https://github.com/Sunwood-ai-labs/Gaiah), [HarmonAI_II](https://github.com/Sunwood-ai-labs/HarmonAI_II), and [IRIS](https://github.com/Sunwood-ai-labs/IRIS).
...
- Offers different instruction templates (podcast, lecture, summary, etc.) to choose from
- Customizable text generation and voice models
- Ability to choose different voices for the speaker

## 🔧 How to Use

1. Upload one or more PDF files
2. Select your desired instruction template
...
Note: Change the path and instance ID to match your environment.
...
This version introduces the Streamlit application for converting PDF to audio. It also adds various workflows and scripts and enhances GitHub integration. See the [v0.1.0 release notes](https://github.com/Sunwood-ai-labs/pdf2audio-JP-st/releases/tag/v0.1.0) for more details.
